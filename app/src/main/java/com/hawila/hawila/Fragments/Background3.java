...
public class Background3 extends BaseFragment {

    ImageView back3;
    DatabaseReference mDatabase;
    StorageReference mStorage;
    public static Background3 create(){
        return new Background3();
    }

    @Override
    public int getLayoutResId() {
        return R.layout.background3;
    }

    @Override
    public void inOnCreateView(View root, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {

        back3 = (ImageView) root.findViewById(R.id.img3);
        ...
        mDatabase.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                Picasso.with(getActivity()).load(image3).into(back3);
            }
