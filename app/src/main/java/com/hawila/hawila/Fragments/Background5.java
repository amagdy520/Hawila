...
public class Background5 extends BaseFragment {

    ImageView back5;
    DatabaseReference mDatabase;
    StorageReference mStorage;
    public static Background5 create(){
        return new Background5();
    }

    @Override
    public int getLayoutResId() {
        return R.layout.background5;
    }

    @Override
    public void inOnCreateView(View root, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {

        back5 = (ImageView) root.findViewById(R.id.img5);
        ...
        mDatabase.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                Picasso.with(getActivity()).load(image5).into(back5);
            }
            @Override
