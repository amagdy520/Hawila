...
public class SignupActivity extends AppCompatActivity {
    ...
    @Bind(R.id.input_Invitation) EditText _invitation;
    ...
    public void signup() {
        ...
        final String invitation = _invitation.getText().toString();
        ...
        new android.os.Handler().postDelayed(
                new Runnable() {
                    public void run() {
                        if( !TextUtils.isEmpty(email) && !TextUtils.isEmpty(password) && !TextUtils.isEmpty(mobile) && !TextUtils.isEmpty(name)) {
                            mAuth.createUserWithEmailAndPassword(email, password)
                                ...
                                public void onComplete(@NonNull Task<AuthResult> task) {
                                    if( task.isSuccessful())
                                    {
                                        ...
                                        current_user_db.child("Invited By").setValue(invitation);
                                        current_user_db.child("Invitation Code").setValue(user_id);
                                        DatabaseReference in = mDatabase.child(invitation).child("Invite");
                                        in.child(user_id).setValue(email);
                                        onSignupSuccess();
